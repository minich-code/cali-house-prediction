...
class DataTransformationConfig:
    preprocessor_obj_file_path = os.path.join("data_repository", "preprocessor.joblib")
...
class DataTransformation:
    ...
    def get_data_transformer_obj(self):
        try:
            ...
            # Create a log info to indicate completion of above processes 
            logging.info("Data processing complete: categorical and numeric values")
